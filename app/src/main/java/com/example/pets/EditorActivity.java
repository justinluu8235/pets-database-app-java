...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks {
    ...
    //Initialize to receive from intent
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Review intent that was used to start this activity.
        ...
        //Set up touch listener to detect changes on the edit page
    ...
    private void savePet(){
        ...
        //Check to see if weight is empty before parseInt to prevent crash
        if(!TextUtils.isEmpty(weightString)){
            weightInt = Integer.parseInt(weightString);
        }
        //if user doesnt enter anything, dont add it
        if (currentPetUri == null &&
    ...
    private void updatePet(){
        ...
        int weightInt = 0;
        int genderInt = mGender;
        //check for empty string to prevent crash when using parseInt
        if(!TextUtils.isEmpty(weightString)){
            weightInt = Integer.parseInt(weightString);
        }
        //if user doesnt enter anything, dont add it
        ...
        //update pet
        int numsRowsUpdated = getContentResolver().update(currentPetUri, values,null, null);


        Context context = getApplicationContext();
        if(numsRowsUpdated == 0) {
            Toast toast = Toast.makeText(context, R.string.toast_update_pet_error, Toast.LENGTH_SHORT);
            toast.show();
        }
        else{
            Toast toast = Toast.makeText(context, R.string.toast_update_pet_success, Toast.LENGTH_SHORT);
            toast.show();
        }
    ...
    public Loader onCreateLoader(int id, @Nullable Bundle args) {
        ...
        CursorLoader loader =  new CursorLoader(this, currentPetUri, projection, null, null, null);
        return loader;
    ...
    public void onLoadFinished(@NonNull Loader loader, Object data) {
        ...
        //move cursor to the first row (the only row)
